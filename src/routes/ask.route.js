...
const agent = new http.Agent({ keepAlive: true, noDelay: true });
...
router.post("/", async (req, res) => {
  try {
    ...
    await supabase.from("questions").insert([
      { question: cleanText, extracted_text: extractedText || null, answer: fullAnswer },
    ]);
